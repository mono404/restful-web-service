            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="blog_right_sidebar">
                        <div class="button-group-area mt-40" style="margin: auto; margin-bottom: 50px">
                            <a href="#" class="genric-btn primary circle">play</a>
                            <a href="#" class="genric-btn primary circle">pause</a>
                            <a href="#" class="genric-btn primary circle">stop</a>
                        </div>
                        <div class="container">
                            <div class="row">
